...
(function (window) {
  ...
  var translations = {
    th: {
      ...
      badge_live: "ไลฟ์",
      badge_event: "อีเวนต์",
      birthday_label: "วันเกิดประจำเดือน",
      birthday_empty: "เดือนนี้ไม่มีเมมเบอร์วันเกิด",
      news_title: "ข่าวสาร",
    ...
    en: {
      ...
      badge_live: "LIVE",
      badge_event: "EVENT",
      birthday_label: "BIRTHDAY THIS MONTH",
      birthday_empty: "No birthdays this month",
      news_title: "NEWS",
    ...
    ja: {
      ...
      badge_live: "ライブ",
      badge_event: "イベント",
      birthday_label: "今月の誕生日",
      birthday_empty: "今月誕生日のメンバーはいません",
      news_title: "ニュース",
